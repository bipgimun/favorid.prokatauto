...
function main({
    ...
    return new Promise((resolve, reject) => {
        ...
        if (unitName == 'carRents') {
            titleUnitValue = 'проката';
        } else if (unitName == 'apartmentRents') {
            titleUnitValue = 'отеля';
        } else if (unitName == 'contracts') {
            titleUnitValue = 'МУЗов';
        }

        ws.cell(1, 1, 1, 5, true)
            .string(`Рентабельность ${titleUnitValue}`)
        ...
        const fileName = `project-profit.${new Date().getTime()}.xlsx`;
